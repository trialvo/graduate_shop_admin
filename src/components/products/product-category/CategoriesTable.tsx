                ...
                return (
                  <React.Fragment key={m.id}>
                    <tr className="border-b border-gray-100 dark:border-gray-800">
                      ...
                      <td className="p-3">{m.status ? <Badge tone="green">Enabled</Badge> : <Badge tone="red">Disabled</Badge>}</td>
                                          ...
                                          <tr className="border-t border-gray-100 dark:border-gray-800">
                                            <td className="p-3">
                                              <button
                                                ...
                                                className="inline-flex h-8 w-8 items-center justify-center rounded-[4px] border border-gray-200 hover:bg-gray-50 dark:border-gray-800 dark:hover:bg-white/[0.03]"
                                                onClick={() =>
                                                  setOpenSub((p) => ({ ...p, [subOpenKey]: !p[subOpenKey] }))
                                                }
                                            ...
                                            <td className="p-3">{s.status ? <Badge tone="green">Enabled</Badge> : <Badge tone="red">Disabled</Badge>}</td>
        ...
        <table className="w-full min-w-[1000px] text-left text-sm">
          <thead className="bg-gray-50 text-xs font-semibold text-gray-600 dark:bg-white/5 dark:text-gray-300">
            <tr>
              ...
              <th className="p-3">Name</th>
              <th className="p-3">Image</th>
              <th className="p-3">{tab === "sub" ? "Main ID" : "Sub ID"}</th>
              <th className="p-3">Status</th>
              <th className="p-3">Featured</th>
              <th className="p-3">Priority</th>
              <th className="p-3 text-right">Actions</th>
            ...
            {!loading &&
              rows.map((r: any) => (
                <tr key={r.id} className="border-b border-gray-100 last:border-b-0 dark:border-gray-800">
                  ...
                  <td className="p-3">
                    <Badge tone="blue">
                      {tab === "sub" ? `main: ${r.main_category_id}` : `sub: ${r.sub_category_id}`}
                    </Badge>
                  </td>
